// from https://github.com/CardJs/CardJs/blob/05980e89810a682db474eb0429da3b0fba6e5e37/src/js/card-js.js
...
CardJs.prototype.setupCardNumberInput = function() {
  ...
  let wrapper = this.cardNumberInput.parent();
  wrapper.addClass("card-number-wrapper");
...
CardJs.prototype.setupNameInput = function() {
  if (this.captureName) {
    let wrapper = this.nameInput.parent();
    wrapper.addClass("name-wrapper");
    wrapper.append("<div class='icon'></div>");
...
CardJs.prototype.setupExpiryInput = function() {
  ...
  let wrapper = this.expiryMonthInput.parent();
  wrapper.addClass("expiry-wrapper");
...
CardJs.prototype.setupCvcInput = function() {
  ...
  let wrapper = this.cvcInput.parent();
  wrapper.addClass("cvc-wrapper");
  wrapper.wrap("<div class='cvc-container'></div>");
